...
export function mergePayeeEntities(a:ReplicatedEntity<PayeeEntityFields>,b:ReplicatedEntity<PayeeEntityFields>):ReplicatedEntity<PayeeEntityFields>{if(a.metadata.id!==b.metadata.id)throw new TypeError("Cannot merge different payees.");const tombstone=!a.metadata.tombstone?b.metadata.tombstone:!b.metadata.tombstone?a.metadata.tombstone:compareHybridTimestamps(a.metadata.tombstone,b.metadata.tombstone)>=0?a.metadata.tombstone:b.metadata.tombstone;const fields:any={};for(const key of Object.keys(a.fields))fields[key]=mergeLwwRegisters((a.fields as any)[key],(b.fields as any)[key]);return Object.freeze({metadata:Object.freeze({...a.metadata,tombstone}),fields:Object.freeze(fields)})}
