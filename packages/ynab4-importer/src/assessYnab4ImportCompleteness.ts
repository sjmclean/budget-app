...
const ITEMS: Ynab4CompletenessItem[] = [
  ...
  },
  {
    ...
    currentAppCapability: "Category groups exist, but there is no category group settings/notes model equivalent to CategorySettings.notes.",
    status: "missing",
    risk: "critical",
    importImpact: "YNAB4 category header notes cannot be preserved. This is a direct full-fidelity migration blocker.",
    requiredBeforeFullImport: true,
    recommendedAction: "Add CategoryGroupSettings or a notes field for category groups before full import."
  },
  {
    id: "categories",
    area: "Categories",
    ynab4Data: "Subcategories, sort order, hidden categories, cached balances, and individual category notes.",
    currentAppCapability: "Categories exist. CategorySettings has notes/hidden/pinned/colour, but YNAB4 import mapping and UI surfacing are not complete.",
    status: "partial",
    risk: "high",
