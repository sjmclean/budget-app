import { validateTransfer, validateFutureMonth, validateTransaction } from "../packages/budget-engine/src/index.js";
...
assertThrows("same-account transfer rejected", () => validateTransfer("checking", "checking", 1000));
assertThrows("zero-value transfer rejected", () => validateTransfer("checking", "savings", 0));
assertThrows("negative transfer rejected", () => validateTransfer("checking", "savings", -1));

validateFutureMonth("2026-08", "2026-06", 3);
console.log("PASS: valid future month accepted");
assertThrows("future month beyond configured limit rejected", () => validateFutureMonth("2027-06", "2026-06", 3));
...
assertThrows("spending transaction without category rejected", () => validateTransaction({
  id: "tx-invalid",
  budgetId: "budget-1",
  accountId: "account-1",
  payeeId: null,
