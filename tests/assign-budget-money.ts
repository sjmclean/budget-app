...
let budgetMonth = addIncomeToBudgetMonth(createBudgetMonth("budget", "2026-06"), 400000); let rent = createCategoryMonth(budgetMonth.id, "rent"); const result = assignToCategoryMonth(budgetMonth, rent, 180000); console.log({ readyToBudget: result.budgetMonth.readyToBudget, rent: result.categoryMonth });
