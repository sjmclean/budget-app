...
test("Budget page preserves the complete Ready to Assign breakdown beside the outlook", () => {
  ...
  assert.match(budgetPageSource, /className="budget-ready-summary-total"/);
